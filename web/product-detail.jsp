...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .product-detail__name{font-size:2.2rem;font-weight:bold;margin-bottom:.2rem;margin-top: 0}
        ...
        .product-detail__specs h4{margin:0 0 .5rem 0;font-size:1.4rem;font-weight:bold;font-size: 23px}
        .product-detail__specs p{margin:0;font-size: 18px}
        ...
        .btn-add{background-color:#ff4d4f;color:#fff;font-size: 20px}
        .btn-back{background-color:#eee;color:#333;font-size: 20px}
        ...
        .comments__header{padding:16px 20px;font-weight:700;font-size:1.5rem;border-bottom:1px solid var(--border)}
        .comment-form{padding:16px 20px;display:grid;grid-template-columns:1fr auto;gap:12px}
        .comment-form select{border:1px solid var(--border);border-radius:10px;padding:10px;font-size: 25px}
        .comment-form textarea{grid-column:1/-1;min-height:96px;resize:vertical;border:1px solid var(--border);
          border-radius:12px;padding:12px;font-size: 25px}
        ...
        .comment-item{display:flex;gap:12px;padding:14px 0;border-top:1px solid var(--border);font-size: 25px}
        ...
        .cdate{color:#777;font-size:20px}
        .stars{letter-spacing:2px;font-size:.95rem;color:#ffb400;font-size: 25px}
        .ccontent{margin:6px 0 0 0}
        .cactions button{background:transparent;border:0;color:#888;cursor:pointer ;font-size: 20px}
        ...
        <c:otherwise>
          <div style="padding:16px 20px">
            <a class="btn btn--ghost"
               href="${pageContext.request.contextPath}/login?returnUrl=./product-detail?id=${param.id}">
