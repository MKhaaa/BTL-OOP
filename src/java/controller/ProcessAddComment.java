...
public class ProcessAddComment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try { if (ratingStr != null && !ratingStr.isBlank()) c.setRating(Integer.parseInt(ratingStr)); } catch (NumberFormatException ignore) {}
        try { if (parentIdStr != null && !parentIdStr.isBlank()) c.setParentId(Integer.parseInt(parentIdStr)); } catch (NumberFormatException ignore) {}
